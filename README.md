...
Tech Stack
LayerTechnologyBackendPython 3.12 + Django 5.0APIDjango REST FrameworkAuthenticationJWT via djangorestframework-simplejwtDatabase (dev)SQLiteDatabase (prod)PostgreSQL 16Filtersdjango-filterEnvironment variablespython-decouple
...
Roadmap
 ...
 Phase 1 — Base models (core)
 Phase 2 — Multi-tenancy (tenants)
 Phase 3 — Users and RBAC (accounts)
 Phase 4 — Financial transactions (transactions)
 Phase 5 — Immutable audit (audit)
 Phase 6 — Financial reports (reports)
